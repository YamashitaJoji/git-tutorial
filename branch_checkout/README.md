...
🎏 When you want to create a new feature or fix a bug, it's better to create a separate branch. You can switch between branches freely without affecting the main codebase.
...
6. Switch back to the `master` branch:
   ...
   The changes you made in the `feature` branch ⬆️ will not be present in the `master` branch.
...
🎉 Great job! You have successfully created and switched between branches in your Git repository.
